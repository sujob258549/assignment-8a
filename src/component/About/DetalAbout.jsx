...
const DetalAbout = ({ book }) => {
    ...
    return (
        <div>
            ...
            <div className="">
                <NavLink to={`/aboutbook/${bookId}`}>
                    <div className="card shadows">
                        <div className="bg-slate-200 px-10 mt-10 rounded-lg mx-10">
                            <figure><img className="w-48 h-32 object-cover" src={image} alt="Shoes" /></figure>
                        </div>
...
DetalAbout.propTypes = {
    book: PropTypes.object
  };

export default DetalAbout;